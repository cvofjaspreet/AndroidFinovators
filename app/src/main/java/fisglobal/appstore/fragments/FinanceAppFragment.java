...
import fisglobal.appstore.adapters.FinanceAppAdapter;

/**
 * Created by Jaspreet.Chhabra on 5/18/2017.
 */

public class FinanceAppFragment extends Fragment {

    private RecyclerView appsGrid;
    private static FinanceAppFragment instance;

    public static FinanceAppFragment getInstance() {
        if(instance==null)
            instance=new FinanceAppFragment();
        return instance;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        appsGrid.setAdapter(new FinanceAppAdapter(getContext()));
    }
}
