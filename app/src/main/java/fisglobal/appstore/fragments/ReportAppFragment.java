...
import fisglobal.appstore.adapters.ReportAppAdapter;
...
public class ReportAppFragment extends Fragment {
    ...
    private static ReportAppFragment instance;

    public static ReportAppFragment getInstance() {
        if(instance==null)
            instance=new ReportAppFragment();
        return instance;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        appsGrid.setAdapter(new ReportAppAdapter(getContext()));
    }
}
