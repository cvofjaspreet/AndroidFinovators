...
public class EmployeeAppAdapter extends RecyclerView.Adapter<EmployeeAppAdapter.ViewHolder> {

    private final Context mContext;

    public EmployeeAppAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(position==0)
        {
            ...
            holder.name.setText("Attendance");
        } else if(position==1)
        {
            holder.icon.setImageResource(R.mipmap.ic_launcher);
            holder.name.setText("Work Hours");
        }else{
            holder.icon.setImageResource(R.mipmap.ic_launcher);
